...
const specs = [
  { label: "Cuisine", value: "Spanish & Italian" },
  { label: "Open Hours", value: "16:00 – 04:00" },
  { label: "Location", value: "Tanger" },
  { label: "Vibe", value: "Good Vibes Only" },
];
