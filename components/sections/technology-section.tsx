...
const sideImages = [
  {
    src: "/images/ambiance-left.jpg",
    alt: "Live percussion performance at Shanzoo",
    position: "left",
  },
  {
    src: "/images/ambiance-right.jpg",
    alt: "Fire dancer performance at Shanzoo",
    position: "right",
  },
];
...
export function TechnologySection() {
  ...
  const descriptionText = "Every night at Shanzoo is an experience. Live belly dancers, fire performers and percussionists set the rhythm while our chefs bring Spanish and Italian classics to your table. Come for dinner, stay for the show — eat, drink and chill until 4am.";
          ...
          >
            ...
            >
              ...
              <Image
                ...
                alt="Belly dancer performance at Shanzoo"
                fill
                className="object-cover"
                style={{
              ...
              <Image
                ...
                alt="Dancer performing amid the tables at Shanzoo"
                fill
              ...
              <Image
                ...
                alt="LED performer under Shanzoo neon lights"
                fill
                className="absolute inset-0 object-cover"
                style={{
