...
export function GallerySection() {
  ...
  const images = [
    { src: "/images/gallery-1.jpg", alt: "Oriental dancer performing at Shanzoo" },
    { src: "/images/gallery-2.jpg", alt: "Close-up of Shanzoo dancer costume detail" },
    { src: "/images/gallery-3.jpg", alt: "Guest enjoying champagne at Shanzoo" },
    { src: "/images/gallery-4.jpg", alt: "Bartender flair fire show at Shanzoo" },
  ];
