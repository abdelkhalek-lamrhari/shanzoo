...
const sideImages = [
  {
    ...
    alt: "Shanzoo restaurant elegant interior with chandelier",
    position: "left",
    span: 1,
  },
  {
    src: "/images/hero-side-2.jpg",
    alt: "Shanzoo dining table set for the evening",
    position: "left",
    span: 1,
  },
  {
    src: "/images/hero-side-3.jpg",
    alt: "Shanzoo storefront glowing at night in Tanger",
    position: "right",
    span: 1,
  },
  {
    src: "/images/hero-side-4.jpg",
    alt: "Fire performance show at Shanzoo",
    position: "right",
    span: 1,
  },
];
        ...
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              ...
              >
                <h1 className="whitespace-nowrap text-[20vw] font-bold leading-[0.8] tracking-tighter text-primary">
              ...
              <Image
                src="/images/heroshanzo.png"
                alt="SHANZOO restaurant glowing beside a reflective pool at night"
                fill
