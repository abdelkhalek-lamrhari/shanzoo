      ...
      <div ref={descriptionRef} className="px-6 pt-8 pb-20 md:px-12 md:pt-12 md:pb-28 lg:px-20 lg:pt-16 lg:pb-36">
        <div className="text-center">
          ...
          <p className="mt-8 leading-relaxed text-muted-foreground text-3xl text-center">
            {("Shanzoo Tanger is where the night comes alive. Specialized in Spanish & Italian cuisine, crafted cocktails and live entertainment, we bring together great food, warm hospitality and unforgettable vibes — open every night from 16:00 to 04:00.").split(" ").map((word, index, array) => {
